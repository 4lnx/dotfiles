...
local terminal = "GTK_IM_MODULE=gtk-im-context-simple ghostty"
local fileManager = "dolphin"
-- local menu = "rofi -show drun -show-icons"
local menu = ".config/rofi/launchers/launcher.sh"
local clipboard = ".config/rofi/launchers/cliphist.sh"
-- local web_browser = "brave --password-store=basic"
...
hl.bind(mainMod .. " + O", hl.dsp.exec_cmd(keepassxc))

hl.bind("ALT + Q", hl.dsp.window.close())

hl.bind(
  mainMod .. " + ALT + SHIFT + DELETE",
